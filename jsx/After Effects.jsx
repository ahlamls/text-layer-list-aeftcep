        ...
        if (layerCount > 0){
            ...
            for (var i = 1; i <= layerCount; ++i){
                ...
                if (currentLayer instanceof TextLayer){
                    ...
                    textlist.push(currentLayer.text.sourceText.value);
                }
            }
            return textlist;
        } else {
          return "<b style='color:#ff0000'>No text layers in " + currentComp.name + ".</b>";
        }
    } else {
        return "<b style='color:#ff0000'>No active Comp . please select or create a composition</b>";
    }
}
